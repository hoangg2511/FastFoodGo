  ...
  Future<List<MonAnModel>> getMonAnTheoCuaHang(
    ...
    try {
      ...
      if (_allMonAn.isNotEmpty) {
        ...
        print("⚠️ Danh sách món ăn cho cửa hàng $cuaHangId rỗng.");
      }

      // 4. Cập nhật State (Giữ nguyên)
